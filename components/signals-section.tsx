...
const signals = [
  {
    date: "AI IDE",
    title: "Cursor AI",
    note: "The AI-native code editor. Built for pair programming with LLMs.",
  },
  {
    date: "AGENT EDITOR",
    title: "Windsurf",
    note: "Next-gen editor offering deep context and agentic flows.",
  },
  {
    date: "GEN UI",
    title: "v0 by Vercel",
    note: "Generative UI system. Prompts to production-ready React code.",
  },
  {
    date: "WEB AGENT",
    title: "Bolt.new",
    note: "Full-stack development agent in the browser.",
  },
  {
    date: "ASSISTANT",
    title: "GitHub Copilot",
    note: "The industry standard for code completion and chat.",
  },
  {
    date: "AUTONOMOUS",
    title: "Replit Agent",
    note: "From idea to deployed app with natural language.",
  },
]
  ...
  return (
    <section id="updates" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">01 / AI RADAR</span>
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">TOOLS WATCH</h2>
      </div>
    ...
    >
      ...
      <div className="relative bg-card border border-border/50 md:border-t md:border-l md:border-r-0 md:border-b-0 p-8">
        ...
        <div className="flex items-baseline justify-between mb-8">
          ...
          <span className="w-24 shrink-0 font-mono text-xs text-accent">{signal.date}</span>
        </div>
