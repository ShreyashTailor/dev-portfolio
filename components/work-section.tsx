...
const experiments = [
  {
    title: "CertiSwift",
    medium: "AI & EdTech Platform",
    description: "AI-powered certification discovery and career growth platform. Features smart course recommendations, real-time learning insights, and verified credentials.",
    span: "col-span-2 row-span-2",
  },
  {
    title: "Valencz",
    medium: "Digital Commerce",
    description: "Premium brand identity and e-commerce experience with minimalist aesthetic.",
